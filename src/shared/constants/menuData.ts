...
export const MENU_DATA: MenuItem[] = [
...

    {
        ...
        children: [
            ...
            { label: "Make Online Claim", path: "/claim" },

            { label: "Cashless Facilities", path: "/cashless-facilities" },

            { label: "Track your Claim", path: "/track-claim" },
...

    {
        ...
        children: [
            ...
            { label: "Premium Calculator", path: "/premium-calculator" },
    ...
    { label: "Payment Channels", path: "/payment" },
