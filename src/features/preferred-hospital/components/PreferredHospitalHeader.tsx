...
const HEADER_DATA: HeaderData = {
    title: [],
    background_image_url: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=2053&auto=format&fit=crop',
};

const PreferredHospitalHeader = () => {
    return (
...
export default PreferredHospitalHeader;
