...
const HEADER_DATA: HeaderData = {
    title: [],
    background_image_url: 'https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2070&auto=format&fit=crop',
};

const PartnerChannelsHeader = () => {
    return (
...
export default PartnerChannelsHeader;
