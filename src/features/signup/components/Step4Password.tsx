  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between border-b pb-2">
        <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Generate Password</span>
        <span className="text-xs font-bold text-gray-400 capitalize">Step 4/4</span>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2 py-2">
          <div className="flex justify-between items-center">
            <span className="text-xs font-semibold text-gray-500">Password must include</span>
            {!allRulesValid && password.length > 0 && (
              <span className="text-[10px] font-bold text-red-400 uppercase">Too Weak</span>
            )}
          </div>
